...
const contents = {
  ...
  right_text_1:"Pro GenX is a cutting-edge technology company revolutionizing the industry with innovative solutions in Web Services.",
  right_text_2:"Software Services, App Development, AI, cloud computing, cybersecurity, and IoT.",
  client_icon:'/assets/img/about/testi-7.png',
  client_name:'Wiktor Schmidt',
  client_title:'Executive Chairman (orix)',
  desc:"Wow. What a great experience with proGenX.It is a very talented digital agnecy. yesterday.",
